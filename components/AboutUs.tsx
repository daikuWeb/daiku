...
export function AboutUs() {
  ...
  return (
    <section className="bg-white">
      {/* Bagian 1: Hero Image */}
      <div className="relative min-h-screen w-full flex flex-col md:flex-row items-center overflow-hidden pt-20 md:pt-0">
        {/* Text section */}
        <div className="w-full md:w-1/2 px-6 py-8 order-1 md:order-2 z-10">
        ...
        {/* Image section */}
        <div className="w-full md:w-1/2 order-2 md:order-1 relative mt-4 md:mt-0">
          <div className="absolute right-0 top-1/2 md:-translate-y-1/2 h-[50vh] md:h-screen w-[150%] md:w-[140%]">
            <Image
              src="/about/1.png"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {[...Array(18)].map((_, index) => (
          <div 
            ...
            onClick={() => setSelectedImage(`/about/${index + 6}.png`)}
          >
            <Image
      ...
      {/* Modal untuk gambar yang diklik */}
      {selectedImage && (
        <div 
